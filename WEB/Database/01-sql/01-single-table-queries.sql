...
SELECT LastName, FirstName, Country FROM customers WHERE Country IN ('Canada', 'Germany', 'Fracne');

SELECT LastName, FirstName, Country FROM customers WHERE Country NOT IN ('Canada', 'Germany', 'Fracne');
